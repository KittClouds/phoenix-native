...
const ALPHA_GRID: [f32; 7] = [-0.10, -0.05, -0.025, 0.0, 0.025, 0.05, 0.10];
...
fn main() -> Result<()> {
    ...
    let receipt = Receipt {
        contract: "phoenix.qps.r3h-human-authority-microscope/v1",
        dataset,
        status: "fiqa_eligible_sci_fact_underpowered",
